...
public class assign_skin_on_start {
    public static void assignskin(Player player, JavaPlugin plugin){
        Random random = new Random();
        int choice = random.nextInt(0,4);
        System.out.println(choice);
        if (choice == 0) {
            setPlayerColor(player, "yellow", plugin.getDataFolder());
            setPlayerSkinPaper(player, "",
            ...
            setPlayerSkinPaper(player, "",
            ...
            setPlayerSkinPaper(player, "",
            ...
            setPlayerSkinPaper(player, "",
